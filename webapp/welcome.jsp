  ...
  <div class="row">
    ...
    <div class="col-sm-4"> 
      ...
      <div class="panel panel-primary">
        ...
        <a href="addToCart.jsp?p=9"><button class="button" style="vertical-align:middle; width:97%" id="101"><span>Add to cart </span></button></a>
      </div>
    </div>
      <div class="col-sm-4"> 
      <div class="panel panel-primary">
        ...
        <a href="addToCart.jsp?p=101"><button class="button" style="vertical-align:middle; width:97%" id="102"> <!-- onclick="confirmBox()"> --><span>Add to cart </span></button></a>
      </div>
    </div>
      <div class="col-sm-4"> 
      <div class="panel panel-primary">
        ...
        <a href="addToCart.jsp?p=102"><button class="button" style="vertical-align:middle; width:97%" id="103"> <!-- onclick="confirmBox()"> --><span>Add to cart </span></button></a>
      </div>
    </div>
      <div class="col-sm-4"> 
      <div class="panel panel-primary">
        ...
        <div class="panel-footer">Rs. 50</div>
        <a href="addToCart.jsp?p=103"><button class="button" style="vertical-align:middle; width:97%" id="104"><!--  onclick="confirmBox()"> --><span>Add to cart </span></button></a>
      </div>
    </div>
  </div>
</div><br><br>
